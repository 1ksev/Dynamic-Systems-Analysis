...
3. **Download the File**
   ...
   Click the file name to download it to your computer. It usually appears in your “Downloads” folder.

4. **Open the Downloaded File**

   - On Windows, double-click the `.exe` file or extract the `.zip` and run the executable.
   - On macOS, open the `.dmg` or unzip the file and drag the application to your Applications folder.
...
- If it is a compressed file (like `.zip`), use your computer's built-in tool to unzip it.
- To start, double-click the program file inside the folder.
...
1. Select or enter parameters such as the suspension type or vehicle mass.
2. Press the 'Run Simulation' button.
3. Watch the graphs show how the suspension reacts over time.
4. Use available controls to zoom in or pause the simulation.
5. If you want, save the results to a file for later study.
